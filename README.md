...
45 merged pull requests, 41 of them upstream at
**[PHPOffice](https://github.com/PHPOffice)**.

| Project | PRs | Contributions |
|---|---|---|
| [PhpProject](https://github.com/PHPOffice/PhpProject) · 209 ★ | 32 | File reader fixes, stabilising flaky tests |
| [PHPPresentation](https://github.com/PHPOffice/PHPPresentation) · 1.4k ★ | 3 | Test coverage under PHPUnit 10+, version compatibility |
| [Common](https://github.com/PHPOffice/Common) | 3 | PHPStan level 7, PHPStan 2.x support, PHP 8.5 CI |
| [PHPWord](https://github.com/PHPOffice/PHPWord) | 2 | PHP 8.5 support, PHPUnit version constraint |
| [Math](https://github.com/PHPOffice/Math) | 1 | PHP 8.5 CI |
